...
{
       0,     0,     3,    13,    15,    17,    25,    28,    29,    30,
      40,    47,    54,    61,    68,    75,    76,    82,    83,    86,
      87,    92,    99,   106,   113,   120,   127,   134,   135,   138,
     139,   148,   154,   157,   158,   171,   174,   175,   189,   191
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      31,     0,    -1,    23,    32,    24,    33,    38,    42,    21,
      32,    24,    -1,     4,    -1,     5,    -1,    23,    16,    24,
      34,    21,    16,    24,    -1,    34,    35,    -1,    -1,    -1,
      23,    15,    37,    24,    36,    45,    21,    15,    24,    -1,
      37,    13,    28,    29,    26,    29,    -1,    37,    13,    28,
      29,     6,    29,    -1,    37,     7,    28,    49,    27,    49,
      -1,    37,    20,    28,    49,    27,    49,    -1,    37,    10,
      28,    49,    27,    49,    -1,    -1,    18,    24,    39,    19,
      24,    -1,    -1,    39,    40,    -1,    -1,    23,    17,    41,
      22,    -1,    41,    13,    28,    29,    26,    29,    -1,    41,
      15,    28,    49,    27,    49,    -1,    41,    14,    28,    49,
      27,    49,    -1,    41,    10,    28,    49,    27,    49,    -1,
      41,     7,    28,    49,    27,    49,    -1,    41,     9,    28,
      49,    27,    49,    -1,    -1,    42,    43,    -1,    -1,    23,
       3,    44,    24,    25,    21,     3,    24,    -1,    15,    28,
      49,    27,    49,    -1,    45,    46,    -1,    -1,    23,     8,
      13,    28,    29,    26,    29,    24,    47,    21,     8,    24,
      -1,    47,    48,    -1,    -1,    23,    11,    14,    28,    49,
      27,    49,    12,    28,    49,    27,    49,    22,    -1,    29,
      -1,    -1
};
...
{
  "$end", "error", "$undefined", "T_BIN", "T_CLOFEXE", "T_CLEFEXE",
  "T_CODESTAR", "T_DEFINED", "T_FILE", "T_GLOBAL", "T_ID", "T_LINE",
  "T_LINENO", "T_NAME", "T_OFFSET", "T_SEGMENT", "T_SEGMENTS", "T_SYMBOL",
  "T_SYMBOLS", "T_ESYMBOLS", "T_TYPE", "T_LS", "T_SG", "T_L", "T_G",
  "T_CODE", "T_STRING", "T_NUMBER", "'='", "'\"'", "$accept", "module",
  "exetype", "sec_segments", "segments", "segment", "$@1", "seg_attribs",
  "sec_symbols", "symbols", "symbol", "sym_attribs", "bins", "bin",
  "bin_attribs", "debuginfo", "debugfile", "debuglines", "debugline", "oq", 0
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     275,   276,   277,   278,   279,   280,   281,   282,    61,    34
};
# endif
...
#line 67 "readclofparse.y"
    {
    if ((yyvsp[(2) - (9)].i) != (yyvsp[(8) - (9)].i)) {
		yyerror ("opening tag does not match closing tag"); YYABORT;
		}
		modules[current_module].type = (yyvsp[(2) - (9)].i);
		}
    break;
...
#line 86 "readclofparse.y"
    { if (!newSegment (&((yyvsp[(3) - (4)].seg)))) YYABORT;}
    break;
...
#line 87 "readclofparse.y"
    { 
		    modules[current_module].st.segments[(yyvsp[(3) - (9)].seg).id].nfiles = (yyvsp[(6) - (9)].di).nfiles;
		modules[current_module].st.segments[(yyvsp[(3) - (9)].seg).id].files = (yyvsp[(6) - (9)].di).files;
		}
    break;
...
#line 109 "readclofparse.y"
    { if (!newSymbol (&((yyvsp[(3) - (4)].sym)))) YYABORT; }
    break;
...
#line 125 "readclofparse.y"
    { 
		    modules[current_module].st.segments[(yyvsp[(3) - (8)].i)].image_size = (yyvsp[(5) - (8)].code).size; 
		modules[current_module].st.segments[(yyvsp[(3) - (8)].i)].escapes = (yyvsp[(5) - (8)].code).escapes; 
		modules[current_module].st.segments[(yyvsp[(3) - (8)].i)].image = (yyvsp[(5) - (8)].code).bin; 
		modules[current_module].st.segments[(yyvsp[(3) - (8)].i)].link_overhead = link_overhead; 
		}
    break;
...
#line 136 "readclofparse.y"
    { 
		(yyval.di).nfiles = (yyvsp[(1) - (2)].di).nfiles + 1; 
		(yyval.di).files = safe_realloc ((yyvsp[(1) - (2)].di).files, sizeof (struct DebugFile) *  (yyval.di).nfiles); 
		(yyval.di).files[(yyval.di).nfiles - 1] = (yyvsp[(2) - (2)].df);
		}
    break;
...
#line 145 "readclofparse.y"
    { (yyval.df) = (yyvsp[(9) - (12)].df); (yyval.df).file = (yyvsp[(6) - (12)].s); }
    break;
...
#line 148 "readclofparse.y"
    {
		...
		(yyval.df).flines[(yyval.df).nlines_inuse] = (yyvsp[(2) - (2)].dl);
...
#line 160 "readclofparse.y"
    { (yyval.dl).offset = (yyvsp[(6) - (13)].i); (yyval.dl).line = (yyvsp[(11) - (13)].i); }
    break;



/* Line 1455 of yacc.c  */
#line 1701 "readclofparse.c"
      default: break;
    }

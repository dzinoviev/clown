...
/* Define to 1 if the system has the type `struct termios'. */
...
/* Name of package */
#define PACKAGE "clown"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "dmitry@mcs.suffolk.edu"

/* Define to the full name of this package. */
#define PACKAGE_NAME "clown"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "clown 2.10"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "clown"

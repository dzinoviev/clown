...
| expression_or_selector {
  ...
  puts("foo");
  $$.data[0] = (Uword)((int64_t)$1 << 32 >> 32);
  $$.data[1] = (Uword)((int64_t)$1 >> 32);
  $$.size = 2;
}
| values ',' expression_or_selector { 
  $$.data = safe_realloc($$.data, ($$.size + 2) * sizeof(Dword)); 
  $$.data[$$.size] = (Uword)((int64_t)$3 << 32 >> 32);
  $$.data[$$.size + 1] = (Uword)((int64_t)$3 >> 32);
  puts("foo");
  $$.size = $$.size + 2;
} ;
...
| T_STC
{emit(BUILD_INSTRUCTION_A(STC, 0, 0));} /* STC */
